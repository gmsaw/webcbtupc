                ...
                <form action="{{ route('admin.kompetisi.update', $competition->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="competitionForm">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input 
                                    ...
                                    required 
                                    value="{{ old('nama_lomba', $competition->nama_lomba) }}" 
                            ...
                            <div>
                                ...
                                >{{ old('deskripsi', $competition->deskripsi) }}</textarea>
                                @error('deskripsi')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            @php
                                // Prepare waves data for JavaScript
                                $wavesData = $competition->waves->map(function($w) {
                                    return [
                                ...
                                // Jika tidak ada waves, set default empty array
                                if (empty($wavesData)) {
                                    $wavesData = [['nama_gelombang' => '', 'start_date' => '', 'end_date' => '', 'biaya' => '']];
                                }
                            @endphp
                            ...
                            <div x-data="{ 
                                ...
                                <div x-show="!isUsingWaves" x-transition>
                                    ...
                                    <x-text-input 
                                        ...
                                        min="0" 
                                        value="{{ old('harga_pendaftaran', $competition->harga_pendaftaran) }}" 
                                        ...
                                        <div class="flex flex-col gap-3 p-4 bg-white border border-indigo-100 rounded-xl shadow-sm relative">
                                            ...
                                            <div>
                                                ...
                                                <input 
                                                    ...
                                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm text-sm py-1.5 @error('waves.*.nama_gelombang') border-red-500 @enderror"
                                                    :required="isUsingWaves"
                                                >
                                                @error('waves.*.nama_gelombang')
                                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            <div class="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input 
                                                        ...
                                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm text-xs py-1.5 @error('waves.*.start_date') border-red-500 @enderror"
                                                        :required="isUsingWaves"
                                                    >
                                                    @error('waves.*.start_date')
                                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                                <div>
                                                    ...
                                                    <input 
                                                        ...
                                                        class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm text-xs py-1.5 @error('waves.*.end_date') border-red-500 @enderror"
                                                        :required="isUsingWaves"
                                                    >
                                                    @error('waves.*.end_date')
                                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                                    @enderror
                                                </div>
                                            </div>
                                            <div>
                                                ...
                                                <input 
                                                    ...
                                                    x-model="wave.biaya" 
                                                    placeholder="150000" 
                                                    class="mt-1 block w-full rounded-lg border-gray-300 shadow-sm text-sm py-1.5 @error('waves.*.biaya') border-red-500 @enderror"
                                                    :required="isUsingWaves"
                                                >
                                                @error('waves.*.biaya')
                                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            ...
                            <div class="grid grid-cols-2 gap-4 bg-indigo-50/50 p-4 rounded-2xl border border-indigo-50">
                                <div>
                                    ...
                                    <x-text-input 
                                        ...
                                        required 
                                        value="{{ old('tanggal_mulai', $competition->tanggal_mulai instanceof \Carbon\Carbon ? $competition->tanggal_mulai->format('Y-m-d') : '') }}" 
                                    />
                                    @error('tanggal_mulai')
                                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <x-text-input 
                                        ...
                                        required 
                                        value="{{ old('tanggal_selesai', $competition->tanggal_selesai instanceof \Carbon\Carbon ? $competition->tanggal_selesai->format('Y-m-d') : '') }}" 
                                    />
                    ...
                    <div class="flex items-center gap-3 pt-6 border-t border-gray-100">
                        ...
                        <label for="is_active" class="font-medium text-gray-900 text-lg cursor-pointer">
                            Buka Pendaftaran Lomba (Status Aktif)
                        </label>
                    </div>
