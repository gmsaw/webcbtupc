        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-yellow-50 rounded-xl border border-yellow-200 p-4">
                    <p class="text-xs text-yellow-700 font-medium uppercase tracking-wider">Pending</p>
                    <p class="text-2xl font-bold text-yellow-700">{{ $registrations->where('status_pendaftaran', 'pending')->count() }}</p>
                </div>
                ...
                <div class="bg-red-50 rounded-xl border border-red-200 p-4">
                    <p class="text-xs text-red-700 font-medium uppercase tracking-wider">Rejected</p>
                    <p class="text-2xl font-bold text-red-700">{{ $registrations->where('status_pendaftaran', 'rejected')->count() }}</p>
                </div>
            </div>
